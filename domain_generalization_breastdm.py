"""
Domain generalization: train on ODELIA train/val and externally test on BreastDM.
...
# DEFAULT PATHS
# ============================================================
DEFAULT_DATA_ROOT = Path("breast_mri_final/domain_generalization/DG/dg_dataset")
DEFAULT_TDA_ROOT = Path("breast_mri_final/domain_generalization/DG")

DEFAULT_TRAIN_IMG_ROOT = DEFAULT_DATA_ROOT / "train"
DEFAULT_VAL_IMG_ROOT = DEFAULT_DATA_ROOT / "val"
DEFAULT_TEST_IMG_ROOT = DEFAULT_DATA_ROOT / "BreastDM_TEST"
...
DEFAULT_TEST_TDA_CSV = DEFAULT_TDA_ROOT / "dg_betti_breastdm_test_2_class.csv"

DEFAULT_OUTPUT_DIR = DEFAULT_TDA_ROOT / "dg_breastdm_all_image_and_fusion_models"

TARGET_NAME = "BreastDM"
