"""
Stage 1 — Hyperparameter search — Fusion models (image + TDA)
Trains on ODELIA train, evaluates on ODELIA val.
Never touches test sets.

Usage:
    python stage1_fusion.py --model r3d18 --combo_idx 0
    python stage1_fusion.py --model mc318 --combo_idx 0
    python stage1_fusion.py --model r2plus1d --combo_idx 0

Models:   r3d18 | mc318 | r2plus1d
Combos:   0 to 49 (50 random combinations sampled from total)
"""
...
OUT_ROOT = Path("breast_mri/results/stage1")
...
# ============================================================
SEARCH_SPACE = {
    "lr":           [1e-5, 5e-5, 1e-4, 5e-4, 1e-2, 1e-3],
...
def main(args):
    ...
    out_dir = OUT_ROOT / f"{args.model}_fusion"
    ...
    print(f"Model: {args.model} | Combo {args.combo_idx}/{N_COMBOS-1} | Params: {params}")
    print("Device:", DEVICE)
