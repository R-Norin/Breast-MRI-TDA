"""
Stage 1 — Hyperparameter search — Image only models
Trains on ODELIA train, evaluates on ODELIA val.
Never touches test sets.

Usage:
    python stage1_imgonly.py --model r3d18 --combo_idx 0
    python stage1_imgonly.py --model mc318 --combo_idx 0
    python stage1_imgonly.py --model r2plus1d --combo_idx 0
...
def main(args):
    ...
    out_dir = OUT_ROOT / f"{args.model}_imgonly"
