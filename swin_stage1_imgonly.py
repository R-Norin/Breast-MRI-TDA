"""
Stage 1 — Hyperparameter search — Swin UNETR Image Only
Trains on ODELIA train, evaluates on ODELIA val.
Never touches test sets.

Usage:
    python swin_stage1_imgonly.py --combo_idx 0
    python swin_stage1_imgonly.py --combo_idx 1
    ...
    python swin_stage1_imgonly.py --combo_idx 49
...
def main(args):
    ...
    print(f"Swin UNETR Image Only | Combo {args.combo_idx}/{N_COMBOS-1} | Params: {params}")
    print("Device:", DEVICE)
